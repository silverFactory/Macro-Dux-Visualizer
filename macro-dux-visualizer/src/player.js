      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg">
            ...
            <button onClick={this.startSynthDemo}>Start Synth Demo </button>
            <button onClick={this.handleOnClick}>Start Visualizer Demo</button>
